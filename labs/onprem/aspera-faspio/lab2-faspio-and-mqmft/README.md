...
Now, let's transfer a 10GB file. Run the following commands <br>
...
Now compare the difference between TCP Transfer, and FASPIO gateway transfer of 1GB file. You should see 130% more speed on 1GB, and 266^ more with 10GB file transfer. As the file size, and distance increase, FASP throughputs increase as well. <br>
